...
beforeAll(async () => {
  ...
  try {
    ...
    for (const table of ['users', 'customers', 'service_categories', 'services', 'employees', 'employee_services', 'employee_schedules', 'appointments', 'promotions', 'invoices', 'invoice_details']) {
